...
export RUN_ID="${RUN_ID:-dit4dit_endowam_pseudo_z60_4xpro6000}"
...
export ACCELERATE_CONFIG="${ACCELERATE_CONFIG:-DiT4DiT/config/deepseeds/deepspeed_endowam_4xpro6000.yaml}"
export DEEPSPEED_CONFIG="${DEEPSPEED_CONFIG:-DiT4DiT/config/deepseeds/endowam_zero2_accum2.json}"
